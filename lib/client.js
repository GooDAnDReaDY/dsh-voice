...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const SET_CSS =
      ...
      '.dvo-pcard{background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l1);border-radius:10px;overflow:hidden}' +
      '.dvo-phead{display:flex;align-items:center;gap:10px;width:100%;padding:11px 14px;background:transparent;border:none;cursor:pointer;text-align:left;font:inherit}' +
      '.dvo-phead:hover{background:var(--dsw-alias-bg-layer-2)}' +
      '.dvo-ptitle{font-size:14px;font-weight:600;color:var(--dsw-alias-label-primary)}' +
      '.dvo-phint{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;color:var(--dsw-alias-label-secondary)}' +
      '.dvo-chev{flex:none;display:flex;color:var(--dsw-alias-label-secondary);transition:transform .15s ease}' +
      '.dvo-pcard[data-open="1"] .dvo-chev{transform:rotate(90deg)}' +
      '.dvo-pbody{border-top:1px solid var(--dsw-alias-border-l1)}'
    ...
    function PluginCard(props) {
      ...
      return React.createElement('div', { className: 'dvo-pcard', 'data-open': open ? '1' : '0' },
        React.createElement('button',
          {
          ...
          React.createElement('span', { className: 'dvo-chev' }, chevronIcon()),
          React.createElement('span', { className: 'dvo-ptitle' }, tt('title')),
          React.createElement('span', { className: 'dvo-phint' }, tt('cardHint')),
        ),
